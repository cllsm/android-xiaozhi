...
from backend.audio_codecs.audio_buffer import AudioBuffer
from backend.audio_codecs.audio_converter import AudioConverter
from backend.audio_codecs.opus_codec import OpusCodec, parse_opus_toc
from backend.audio_codecs.audio_bridge import AudioBridge
from backend.constants.constants import AudioConfig
from backend.log import get_logger
from backend.utils.audio_device import AudioDeviceManager, DeviceConfig
...
class AudioCodec:
    ...
    async def initialize(self):
        ...
        try:
            ...
            # 4. 创建音频流
            self.stream_manager = AudioBridge(self.device_config)
