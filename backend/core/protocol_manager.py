...
if TYPE_CHECKING:
    from backend.protocols.protocol import Protocol
...
class ProtocolTransport:
    ...
    def set_protocol(self, protocol_type: str) -> None:
        ...
        if protocol_type == "mqtt":
            from backend.protocols.mqtt_protocol import MqttProtocol

            self._protocol = MqttProtocol(asyncio.get_running_loop())
        else:
            from backend.protocols.websocket_protocol import WebsocketProtocol
